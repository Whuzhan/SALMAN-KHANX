...
\033[1;91m☞ Auther     : SALMAN_KHANX
\033[1;92m☞ WhatsApp   : 03101316135
\033[1;95m☞ YouTube    : https://youtube.com/@salmantechtv6886
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/whuzhan)
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel salman tech tv✓')
